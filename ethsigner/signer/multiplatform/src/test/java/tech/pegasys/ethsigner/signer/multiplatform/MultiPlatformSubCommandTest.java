...
class MultiPlatformSubCommandTest {

  private MultiPlatformSubCommand multiPlatformSubCommand;
  private CommandLine commandLine;

  @BeforeEach
  void beforeEach() {
    multiPlatformSubCommand = new MultiPlatformSubCommand();

    commandLine = new CommandLine(multiPlatformSubCommand);
  ...
  void parseCommandSuccessfullySetDirectory() {
    ...
    final Path path = multiPlatformSubCommand.getDirectoryPath();
