...
class SigningMetadataTomlConfigLoaderTest {
  ...
  void loadMetadataFilePopulatesKeyAndPasswordFilePaths() {
    ...
    assertThat(loadedMetadataFile.get().getKeyFilename()).isEqualTo(fileBasedSigningMetadataFile.getKeyFilename());
    assertThat(loadedMetadataFile.get().getPasswordFilename()).isEqualTo(fileBasedSigningMetadataFile.getPasswordFilename());
