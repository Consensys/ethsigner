...
public class SigningEthSendTransactionIntegrationTest extends IntegrationTestBase {
  ...
  @Test
  public void convertBase10toBase16() {
    BigInteger value =
        new BigInteger(
            "101454411220705080123888225389655371100299455501706857686025051036223022797554");
    System.out.println("value.toString(16) = " + value.toString(16));
  }

  @Test
  public void decode() {
    final String expect =
        "";
    System.out.println(
        "expect = " + new ReflectionToStringBuilder(TransactionDecoder.decode(expect)).toString());
    ...
    System.out.println(
        "request = "
            + new ReflectionToStringBuilder(TransactionDecoder.decode(request)).toString());
  }
