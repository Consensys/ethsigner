...
public class HashicorpHelpers {
  ...
  public static HashicorpSigningParams createLoadedHashicorpVault(boolean useTls) {
    final HashicorpNode hashicorpNode = HashicorpNode.createAndStartHashicorp(useTls);
